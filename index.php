...
<html>
	<head>
		...
		<title> Ariston Family Dental Care in Glen Ellyn, Illinois Niki Douros, DMD Glen Ellyn Dentist Cosmetic Dentistry Pediatric Dental Care Emergency Dental Services Teeth Whitening </title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://www.dourosfamilyandcosmeticdentistry.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-block-b" id="findUS">
						...
						<div data-role="collapsible-set">	
							<div data-role="collapsible" data-theme="<?php echo $theme ?>" data-content-theme="<?php echo $theme ?>" data-iconpos="right" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
							   ...
							   <a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Preventive</a>
							   <a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Pediatric Dental Care</a>
							   <a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Emergency Treatment</a>
							   ...
							   <a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Oral Surgery</a>
							</div>
						</div>						
					
				
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Payment / Insurance</a>
					</div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
            ...
            <p>Ariston Family Dental Care in Glen Ellyn, Illinois Niki J. Douros, DMD. We offer a full range of general and cosmetic dental services.  Our goal is for you and your entire family to receive the quality dental
                care you deserve in our comfortable, relaxing, and friendly enviroment. Our general dentistry services take care of your family’s daily dental needs, whether they may be preventative, restorative, pediatric or
                emergency dental services.  Our cosmetic services include a variety of treatments for patients looking to enhance their smiles. These include teeth whitening, porcelain crowns, veneers, implants and dentures.
                Our network of neighborhood practitioners makes it easy for you to access dental specialists, including orthodontists, endodontists, periodontists,
                and oral surgeons.  We look forward to taking care of  your dental needs.</p>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Service Details</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Payment / Insurance</a></li>
